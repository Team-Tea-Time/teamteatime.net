...
* **Color (light mode):** The accent color to apply to the category in light mode.
* **Color (dark mode):** The accent color to apply to the category in dark mode. UI presets that don't implement a dark mode ignore this value.
...
The following actions can be applied to a single post or a selection of multiple posts:
